...
| 状态 | 耳机型号 | 主控 / 协议 | 依据 |
|---|---|---|---|
| ✅ 已实测 | 梦回2 / Golden Ages 2（GA2） | TWS-01 定制 SoC（GAIA） | 实机验证通过（alpha2.17 修复 GA2 DUAL 连接，alpha2.18 修复假已连接） |
| 🟢 理论上支持 | 爱丽丝 ALICE | QCC5151（GAIA） | 拆解实锤 |
| 🟢 理论上支持 | 火花 SPARKS | QCC3040（GAIA） | 拆解实锤 |
| 🟢 理论上支持 | 旅行者 VOYAGER（颈挂） | QCC5144（GAIA） | 官方规格 / 拆解 |
| 🟢 理论上支持 | 梦回1979 / Golden Ages | 与梦回2同平台同款主控（GAIA） | 同平台换皮（据实机型核实） |
| 🟢 理论上支持 | 猫饼 NEKOCAKE | BT8922E（9ECA） | 拆解实锤 |
| 🟢 理论上支持 | 太空漫游2 / Space Travel 2 | BT8932F（9ECA） | 拆解实锤 |
| 🟢 理论上支持 | 音乐胶囊 PILL | BT8932F（9ECA） | 拆解实锤 |
| 🟢 理论上支持 | 超声波 ULTRASONIC | BT8952F（9ECA） | 拆解实锤 |
| 🟢 理论上支持 | 知更鸟 Robin | BT8952F（9ECA） | 拆解实锤 |
...
- **已实测**：开发者实机验证过
- **理论上支持**：主控芯片已确认（拆解 / 官方）且协议侧能自动识别，但尚未逐一实机跑通
