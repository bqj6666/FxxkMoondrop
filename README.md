...
> 作者：[bqj6666](https://github.com/bqj6666) ｜ 版本：**3.2.0**（versionCode 320） ｜ 许可证：**GPL-3.0**（见 [LICENSE](LICENSE)）

> [![最新正式版](https://img.shields.io/badge/release-3.2.0-2ea44f?style=flat-square&labelColor=555555)](https://github.com/bqj6666/FxxkMoondrop/releases/latest) ｜ [更新日志](CHANGELOG.md)
